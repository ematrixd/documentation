...
# Отслеживание изменений в директории для файлов с расширением .md, включая вложенные директории
inotifywait -m -r --monitor -e modify,create,delete --include '\.md$' $DOCUMENTATION_DIR |
